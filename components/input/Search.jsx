  ...
  methods: {
    ...
    renderAddonAfter(prefixCls) {
      ...
      const isVcuButton =
        ...
        enterButtonAsElement.componentOptions.Ctor.extendOptions.__VCU_BUTTON;
      if (enterButtonAsElement.tag === 'button' || isVcuButton) {
        button = cloneElement(enterButtonAsElement, {
          key: 'enterButton',
          class: isVcuButton ? btnClassName : '',
          props: isVcuButton ? { size } : {},
          on: {
            click: this.onSearch,
          },
        });
