...
export default {
    ...
    methods: {
        monthCellRender2(value) {
            ...
            return ( < div class = { `${prefixCls}-month` } >
                <
                div class = { `${prefixCls}-value` } > { value.localeData().monthsShort(value) } < /div> <div class = { `${prefixCls}-content` }> { monthCellRender(value) } </div > < /div>
            )
        },
        ...
        dateCellRender2(value) {
            ...
            return ( <
                ...
                <
                div class = { `${prefixCls}-value` } > { zerofixed(value.date()) } < /div> <div class = { `${prefixCls}-content` } > { dateCellRender(value) } </div > < /div >
            )
        },
    ...
    render() {
        return ( <
            LocaleReceiver componentName = 'Calendar'
            defaultLocale = { enUs }
            scopedSlots = {
