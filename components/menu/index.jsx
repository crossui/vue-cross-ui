...
const Menu = {
  name: 'VMenu',
  props: menuProps,
  Divider: { ...Divider, name: 'VMenuDivider' },
  Item: { ...Item, name: 'VMenuItem' },
  SubMenu: { ...SubMenu, name: 'VSubMenu' },
  ItemGroup: { ...ItemGroup, name: 'VMenuItemGroup' },
  provide() {
    return {
  ...
  methods: {
    ...
    handleTransitionEnd(e) {
      ...
      const iconScaled = e.propertyName === 'font-size' && classNameValue.indexOf('vcuicon') >= 0;
