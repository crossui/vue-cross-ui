...
const RangeCalendar = {
        ...
        render() {
            ...
            return ( <
                div ref = 'rootInstance'
                class = { className }
                tabIndex = '0' > { props.renderSidebar() } <
                div class = { `${prefixCls}-panel` } > {
                    ...
                    /> < /
                    div > <
                    div class = { cls } > { props.renderFooter() } {
                        showToday || props.timePicker || showOkButton ? ( <
                            div class = { `${prefixCls}-footer-btn` } > { TodayButtonNode } { TimePickerButtonNode } { OkButtonNode } <
                            /div>
                        ) : null
                    } <
                    /div> < /
