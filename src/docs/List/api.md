...
| loading | 当卡片内容还在加载中时，可以用 `loading` 展示一个占位 | boolean\|[object](/Feedback/spin-cn/#api) | false |
| loadMore | 加载更多 | string\|slot | - |
| pagination | 对应的 `pagination` [配置](/Navigation/Pagination#api), 设置 `false` 不显示 | boolean\|object | false |
